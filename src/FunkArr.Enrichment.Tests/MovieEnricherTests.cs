...
public sealed class MovieEnricherTests
{
    ...
    public void Exact_title_match_returns_high_confidence()
    {
        ...
        var results = new MovieEnricher().Resolve(_fightClub, [], candidates);
    ...
    public void Alternative_title_match_works()
    {
        ...
        var results = new MovieEnricher().Resolve(_fightClub, _fightClubAltTitles, candidates);
    ...
    public void Year_mismatch_rejects_match()
    {
        ...
        var results = new MovieEnricher().Resolve(movie, [], candidates);
